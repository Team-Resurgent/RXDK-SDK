...
/*
 * Standard DirectSound DSP effects image (dsstdfx) -- machine-generated by the
 * effects compiler (xgpimage). Provides the effect-index enum and the per-effect
 * STATE layouts for the default APU graph (temp-mixbin zero, voice rate
 * converter, 1xN splitter, I3DL2 reverb, crosstalk, and the four submix voices),
 * plus the default I3DL2 environment preset. Used with the runtime's effect
 * download and GetEffectData / SetEffectData at the named indices.
 */
