...
extern __ehstate_t __cdecl GetCurrentState(EHRegistrationNode*, DispatcherContext*, FuncInfo*);
extern void __cdecl SetState(EHRegistrationNode*, DispatcherContext*, FuncInfo*, __ehstate_t);
