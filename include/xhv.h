...
//
XHVINLINE ULONG WINAPI
IXHVEngine_AddRef(XHVEngine* pThis)
{
    return XHVEngine_AddRef(pThis);
}
XHVINLINE ULONG WINAPI
IXHVEngine_Release(XHVEngine* pThis)
{
    return XHVEngine_Release(pThis);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_EnableProcessingMode(XHVEngine* pThis, XHV_PROCESSING_MODE processingMode)
{
    return XHVEngine_EnableProcessingMode(pThis, processingMode);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetCallbackInterface(XHVEngine* pThis, ITitleXHV* pITitleXHV)
{
    return XHVEngine_SetCallbackInterface(pThis, pITitleXHV);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_GetCallbackInterface(XHVEngine* pThis, ITitleXHV** ppITitleXHV)
{
    return XHVEngine_GetCallbackInterface(pThis, ppITitleXHV);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_DoWork(XHVEngine* pThis)
{
    return XHVEngine_DoWork(pThis);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_RegisterLocalTalker(XHVEngine* pThis, DWORD dwLocalPort)
{
    return XHVEngine_RegisterLocalTalker(pThis, dwLocalPort);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_UnregisterLocalTalker(XHVEngine* pThis, DWORD dwLocalPort)
{
    return XHVEngine_UnregisterLocalTalker(pThis, dwLocalPort);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetProcessingMode(XHVEngine* pThis, DWORD dwLocalPort, XHV_PROCESSING_MODE processingMode)
{
    return XHVEngine_SetProcessingMode(pThis, dwLocalPort, processingMode);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_GetProcessingMode(XHVEngine* pThis, DWORD dwLocalPort, XHV_PROCESSING_MODE* pProcessingMode)
{
    return XHVEngine_GetProcessingMode(pThis, dwLocalPort, pProcessingMode);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetVoiceMask(XHVEngine* pThis, DWORD dwLocalPort, const XHV_VOICE_MASK* pVoiceMask)
{
    return XHVEngine_SetVoiceMask(pThis, dwLocalPort, pVoiceMask);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_GetLocalTalkerStatus(XHVEngine* pThis, DWORD dwLocalPort, XHV_LOCAL_TALKER_STATUS* pLocalTalkerStatus)
{
    return XHVEngine_GetLocalTalkerStatus(pThis, dwLocalPort, pLocalTalkerStatus);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_RegisterRemoteTalker(XHVEngine* pThis, XUID xuidRemoteTalker)
{
    return XHVEngine_RegisterRemoteTalker(pThis, xuidRemoteTalker);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_UnregisterRemoteTalker(XHVEngine* pThis, XUID xuidRemoteTalker)
{
    return XHVEngine_UnregisterRemoteTalker(pThis, xuidRemoteTalker);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_GetRemoteTalkers(XHVEngine* pThis, DWORD* pdwRemoteTalkersCount, XUID* pxuidRemoteTalkers)
{
    return XHVEngine_GetRemoteTalkers(pThis, pdwRemoteTalkersCount, pxuidRemoteTalkers);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SubmitIncomingVoicePacket(XHVEngine* pThis, XUID xuidRemoteTalker, VOID* pvData, DWORD dwSize)
{
    return XHVEngine_SubmitIncomingVoicePacket(pThis, xuidRemoteTalker, pvData, dwSize);
}
XHVINLINE BOOL WINAPI
IXHVEngine_IsTalking(XHVEngine* pThis, XUID xuidRemoteTalker)
{
    return XHVEngine_IsTalking(pThis, xuidRemoteTalker);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetMixBinMapping(XHVEngine* pThis, XUID xuidRemoteTalker, DWORD dwLocalPort, const DSMIXBINS* pMixBins)
{
    return XHVEngine_SetMixBinMapping(pThis, xuidRemoteTalker, dwLocalPort, pMixBins);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetMixBinVolumes(XHVEngine* pThis, XUID xuidRemoteTalker, const DSMIXBINS* pMixBins)
{
    return XHVEngine_SetMixBinVolumes(pThis, xuidRemoteTalker, pMixBins);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetPlaybackPriority(XHVEngine* pThis, XUID xuidRemoteTalker, DWORD dwLocalPort, XHV_PLAYBACK_PRIORITY playbackPriority)
{
    return XHVEngine_SetPlaybackPriority(pThis, xuidRemoteTalker, dwLocalPort, playbackPriority);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SetMaxPlaybackStreamsCount(XHVEngine* pThis, DWORD dwStreamsCount)
{
    return XHVEngine_SetMaxPlaybackStreamsCount(pThis, dwStreamsCount);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_RegisterSpeechRecognitionBank(XHVEngine* pThis, VOID* pvSRBank)
{
    return XHVEngine_RegisterSpeechRecognitionBank(pThis, pvSRBank);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_SelectVocabulary(XHVEngine* pThis, DWORD dwLocalPort, DWORD dwVocabsCount, const XHV_SR_VOCAB_SELECTION* pVocabSelections)
{
    return XHVEngine_SelectVocabulary(pThis, dwLocalPort, dwVocabsCount, pVocabSelections);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_VoiceMailRecord(XHVEngine* pThis, DWORD dwLocalPort, DWORD dwMaxTimeMs, DWORD dwOutputBufferSize, BYTE* pbOutputBuffer)
{
    return XHVEngine_VoiceMailRecord(pThis, dwLocalPort, dwMaxTimeMs, dwOutputBufferSize, pbOutputBuffer);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_VoiceMailPlay(XHVEngine* pThis, DWORD dwLocalPort, DWORD dwInputBufferSize, const BYTE* pbInputBuffer, BOOL bOutputToSpeakers)
{
    return XHVEngine_VoiceMailPlay(pThis, dwLocalPort, dwInputBufferSize, pbInputBuffer, bOutputToSpeakers);
}
XHVINLINE HRESULT WINAPI
IXHVEngine_VoiceMailStop(XHVEngine* pThis, DWORD dwLocalPort)
{
...
XHVINLINE HRESULT WINAPI
IXHVEngine::EnableProcessingMode(XHV_PROCESSING_MODE processingMode)
{
    return XHVEngine_EnableProcessingMode(this, processingMode);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetCallbackInterface(ITitleXHV* pITitleXHV)
{
    return XHVEngine_SetCallbackInterface(this, pITitleXHV);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::GetCallbackInterface(ITitleXHV** ppITitleXHV)
{
...
XHVINLINE HRESULT WINAPI
IXHVEngine::RegisterLocalTalker(DWORD dwLocalPort)
{
    return XHVEngine_RegisterLocalTalker(this, dwLocalPort);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::UnregisterLocalTalker(DWORD dwLocalPort)
{
    return XHVEngine_UnregisterLocalTalker(this, dwLocalPort);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetProcessingMode(DWORD dwLocalPort, XHV_PROCESSING_MODE processingMode)
{
    return XHVEngine_SetProcessingMode(this, dwLocalPort, processingMode);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::GetProcessingMode(DWORD dwLocalPort, XHV_PROCESSING_MODE* pProcessingMode)
{
    return XHVEngine_GetProcessingMode(this, dwLocalPort, pProcessingMode);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetVoiceMask(DWORD dwLocalPort, const XHV_VOICE_MASK* pVoiceMask)
{
    return XHVEngine_SetVoiceMask(this, dwLocalPort, pVoiceMask);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::GetLocalTalkerStatus(DWORD dwLocalPort, XHV_LOCAL_TALKER_STATUS* pLocalTalkerStatus)
{
    return XHVEngine_GetLocalTalkerStatus(this, dwLocalPort, pLocalTalkerStatus);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::RegisterRemoteTalker(XUID xuidRemoteTalker)
{
    return XHVEngine_RegisterRemoteTalker(this, xuidRemoteTalker);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::UnregisterRemoteTalker(XUID xuidRemoteTalker)
{
    return XHVEngine_UnregisterRemoteTalker(this, xuidRemoteTalker);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::GetRemoteTalkers(DWORD* pdwRemoteTalkersCount, XUID* pxuidRemoteTalkers)
{
    return XHVEngine_GetRemoteTalkers(this, pdwRemoteTalkersCount, pxuidRemoteTalkers);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SubmitIncomingVoicePacket(XUID xuidRemoteTalker, VOID* pvData, DWORD dwSize)
{
    return XHVEngine_SubmitIncomingVoicePacket(this, xuidRemoteTalker, pvData, dwSize);
}
XHVINLINE BOOL WINAPI
IXHVEngine::IsTalking(XUID xuidRemoteTalker)
{
    return XHVEngine_IsTalking(this, xuidRemoteTalker);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetMixBinMapping(XUID xuidRemoteTalker, DWORD dwLocalPort, const DSMIXBINS* pMixBins)
{
    return XHVEngine_SetMixBinMapping(this, xuidRemoteTalker, dwLocalPort, pMixBins);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetMixBinVolumes(XUID xuidRemoteTalker, const DSMIXBINS* pMixBins)
{
    return XHVEngine_SetMixBinVolumes(this, xuidRemoteTalker, pMixBins);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetPlaybackPriority(XUID xuidRemoteTalker, DWORD dwLocalPort, XHV_PLAYBACK_PRIORITY playbackPriority)
{
    return XHVEngine_SetPlaybackPriority(this, xuidRemoteTalker, dwLocalPort, playbackPriority);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SetMaxPlaybackStreamsCount(DWORD dwStreamsCount)
{
    return XHVEngine_SetMaxPlaybackStreamsCount(this, dwStreamsCount);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::RegisterSpeechRecognitionBank(VOID* pvSRBank)
{
    return XHVEngine_RegisterSpeechRecognitionBank(this, pvSRBank);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::SelectVocabulary(DWORD dwLocalPort, DWORD dwVocabsCount, const XHV_SR_VOCAB_SELECTION* pVocabSelections)
{
    return XHVEngine_SelectVocabulary(this, dwLocalPort, dwVocabsCount, pVocabSelections);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::VoiceMailRecord(DWORD dwLocalPort, DWORD dwMaxTimeMs, DWORD dwOutputBufferSize, BYTE* pbOutputBuffer)
{
    return XHVEngine_VoiceMailRecord(this, dwLocalPort, dwMaxTimeMs, dwOutputBufferSize, pbOutputBuffer);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::VoiceMailPlay(DWORD dwLocalPort, DWORD dwInputBufferSize, const BYTE* pbInputBuffer, BOOL bOutputToSpeakers)
{
    return XHVEngine_VoiceMailPlay(this, dwLocalPort, dwInputBufferSize, pbInputBuffer, bOutputToSpeakers);
}
XHVINLINE HRESULT WINAPI
IXHVEngine::VoiceMailStop(DWORD dwLocalPort)
{
