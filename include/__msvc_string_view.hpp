...
basic_ostream<_Elem, _Traits>& xdk_ostream_insert_string(
    basic_ostream<_Elem, _Traits>&, const _Elem* const, _SizeT);
#endif
template <>
...
#if defined(_XBOX) // xdk_ostream_insert_string
    return xdk_ostream_insert_string(_Ostr, _Data, _Size);
#else
