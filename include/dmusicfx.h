...
/*
 * DirectMusic DSP effects image (dmusicfx) -- machine-generated by the effects
 * compiler (xgpimage). Provides the effect-index enum and per-effect STATE
 * layouts for the richer DirectMusic APU graph (stereo flange/echo/amp-mod/
 * chorus, 24K I3DL2 reverb, per-channel IIR2, splitter, crosstalk, submix
 * voices), plus its I3DL2 environment presets. Used with the runtime's effect
