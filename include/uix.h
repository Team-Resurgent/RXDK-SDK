...
#define UIX_MAX_LOGON_SERVICES XONLINE_MAX_LOGON_STATE_SERVICES
...
DECLARE_INTERFACE(IUIXEngineInternal)
{
    ...
    STDMETHOD_(BOOL, CanRecordVoiceMailForPort)(THIS_ IN DWORD Port) PURE;
    STDMETHOD_(BOOL, CanPlayVoiceMailForPort)(THIS_ IN DWORD Port) PURE;
...
UIXINLINE ULONG WINAPI
IPluginSupport_AddRef(PluginSupport* pThis)
{
    return PluginSupport_AddRef(pThis);
}
UIXINLINE ULONG WINAPI
IPluginSupport_Release(PluginSupport* pThis)
{
    return PluginSupport_Release(pThis);
}
UIXINLINE HRESULT WINAPI
IPluginSupport_GetString(PluginSupport* pThis, DWORD StringResID, LPCWSTR* ppString)
{
    return PluginSupport_GetString(pThis, StringResID, ppString);
}
UIXINLINE HRESULT WINAPI
IPluginSupport_GetLayout(PluginSupport* pThis, DWORD ScreenResID, DWORD ObjectResID, UIX_SKIN_LAYOUT_INFO** ppLayout)
{
    return PluginSupport_GetLayout(pThis, ScreenResID, ObjectResID, ppLayout);
}
UIXINLINE HRESULT WINAPI
IPluginSupport_GetImage(PluginSupport* pThis, DWORD ImageResID, IDirect3DTexture8** ppTexture)
{
    return PluginSupport_GetImage(pThis, ImageResID, ppTexture);
}
UIXINLINE HRESULT WINAPI
IPluginSupport_GetScreenImage(PluginSupport* pThis, DWORD ScreenResID, DWORD ImageResID, IDirect3DTexture8** ppTexture)
{
    return PluginSupport_GetScreenImage(pThis, ScreenResID, ImageResID, ppTexture);
}
UIXINLINE HRESULT WINAPI
IPluginSupport_GetWordLength(PluginSupport* pThis, LPCWSTR pString, DWORD* pWordLength)
{
...
UIXINLINE ULONG WINAPI
IPluginSupport::AddRef()
{
    return PluginSupport_AddRef(this);
}
UIXINLINE ULONG WINAPI
IPluginSupport::Release()
{
    return PluginSupport_Release(this);
}
UIXINLINE HRESULT WINAPI
IPluginSupport::GetString(DWORD StringResID, LPCWSTR* ppString)
{
    return PluginSupport_GetString(this, StringResID, ppString);
}
UIXINLINE HRESULT WINAPI
IPluginSupport::GetLayout(DWORD ScreenResID, DWORD ObjectResID, UIX_SKIN_LAYOUT_INFO** ppLayout)
{
    return PluginSupport_GetLayout(this, ScreenResID, ObjectResID, ppLayout);
}
UIXINLINE HRESULT WINAPI
IPluginSupport::GetImage(DWORD ImageResID, IDirect3DTexture8** ppTexture)
{
    return PluginSupport_GetImage(this, ImageResID, ppTexture);
}
UIXINLINE HRESULT WINAPI
IPluginSupport::GetScreenImage(DWORD ScreenResID, DWORD ImageResID, IDirect3DTexture8** ppTexture)
{
    return PluginSupport_GetScreenImage(this, ScreenResID, ImageResID, ppTexture);
}
UIXINLINE HRESULT WINAPI
IPluginSupport::GetWordLength(LPCWSTR pString, DWORD* pWordLength)
{
...
UIXINLINE ULONG WINAPI
ILiveFriendsList_AddRef(LiveFriendsList* pThis)
{
    return LiveFriendsList_AddRef(pThis);
}
UIXINLINE ULONG WINAPI
ILiveFriendsList_Release(LiveFriendsList* pThis)
{
    return LiveFriendsList_Release(pThis);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList_Refresh(LiveFriendsList* pThis)
{
    return LiveFriendsList_Refresh(pThis);
}
UIXINLINE BOOL WINAPI
ILiveFriendsList_IsReady(LiveFriendsList* pThis)
{
    return LiveFriendsList_IsReady(pThis);
}
UIXINLINE BOOL WINAPI
ILiveFriendsList_HasChanged(LiveFriendsList* pThis)
{
    return LiveFriendsList_HasChanged(pThis);
}
UIXINLINE DWORD WINAPI
ILiveFriendsList_Count(LiveFriendsList* pThis)
{
    return LiveFriendsList_Count(pThis);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList_GetFriendByIndex(LiveFriendsList* pThis, DWORD FriendIndex, XONLINE_FRIEND* pFriend)
{
    return LiveFriendsList_GetFriendByIndex(pThis, FriendIndex, pFriend);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList_GetFriendByXUID(LiveFriendsList* pThis, XUID FriendXUID, XONLINE_FRIEND* pFriend)
{
    return LiveFriendsList_GetFriendByXUID(pThis, FriendXUID, pFriend);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList_Remove(LiveFriendsList* pThis, const XONLINE_FRIEND* pFriend)
{
    return LiveFriendsList_Remove(pThis, pFriend);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList_Request(LiveFriendsList* pThis, XUID UserXUID)
{
...
UIXINLINE ULONG WINAPI
ILiveFriendsList::AddRef()
{
    return LiveFriendsList_AddRef(this);
}
UIXINLINE ULONG WINAPI
ILiveFriendsList::Release()
{
    return LiveFriendsList_Release(this);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList::Refresh()
{
    return LiveFriendsList_Refresh(this);
}
UIXINLINE BOOL WINAPI
ILiveFriendsList::IsReady()
{
    return LiveFriendsList_IsReady(this);
}
UIXINLINE BOOL WINAPI
ILiveFriendsList::HasChanged()
{
    return LiveFriendsList_HasChanged(this);
}
UIXINLINE DWORD WINAPI
ILiveFriendsList::Count()
{
    return LiveFriendsList_Count(this);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList::GetFriendByIndex(DWORD FriendIndex, XONLINE_FRIEND* pFriend)
{
    return LiveFriendsList_GetFriendByIndex(this, FriendIndex, pFriend);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList::GetFriendByXUID(XUID FriendXUID, XONLINE_FRIEND* pFriend)
{
    return LiveFriendsList_GetFriendByXUID(this, FriendXUID, pFriend);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList::Remove(const XONLINE_FRIEND* pFriend)
{
    return LiveFriendsList_Remove(this, pFriend);
}
UIXINLINE HRESULT WINAPI
ILiveFriendsList::Request(XUID UserXUID)
{
...
UIXINLINE ULONG WINAPI
ILiveEngine_AddRef(LiveEngine* pThis)
{
    return LiveEngine_AddRef(pThis);
}
UIXINLINE ULONG WINAPI
ILiveEngine_Release(LiveEngine* pThis)
{
    return LiveEngine_Release(pThis);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_DoWork(LiveEngine* pThis, DWORD* pDoWorkFlags)
{
    return LiveEngine_DoWork(pThis, pDoWorkFlags);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_SetUIPlugin(LiveEngine* pThis, ITitleUIPlugin* pUIPlugin)
{
    return LiveEngine_SetUIPlugin(pThis, pUIPlugin);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_SetAudioPlugin(LiveEngine* pThis, ITitleAudioPlugin* pAudioPlugin)
{
    return LiveEngine_SetAudioPlugin(pThis, pAudioPlugin);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_EnableFeature(LiveEngine* pThis, UIX_FEATURE FeatureID)
{
    return LiveEngine_EnableFeature(pThis, FeatureID);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_StartFeature(LiveEngine* pThis, UIX_FEATURE FeatureID, const VOID* pFeatureParams)
{
    return LiveEngine_StartFeature(pThis, FeatureID, pFeatureParams);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_Render(LiveEngine* pThis, IDirect3DSurface8* pSurface)
{
    return LiveEngine_Render(pThis, pSurface);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_SetInput(LiveEngine* pThis, DWORD Port, const XINPUT_STATE* pInputState)
{
    return LiveEngine_SetInput(pThis, Port, pInputState);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_GetFriendsForUser(LiveEngine* pThis, DWORD Port, ILiveFriendsList** ppFriendsList)
{
    return LiveEngine_GetFriendsForUser(pThis, Port, ppFriendsList);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_NotificationSetState(LiveEngine* pThis, DWORD Port, DWORD StateFlags, XNKID SessionID, DWORD StateDataSize, const PVOID pStateData)
{
    return LiveEngine_NotificationSetState(pThis, Port, StateFlags, SessionID, StateDataSize, pStateData);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_GetNotifications(LiveEngine* pThis, DWORD Port, UIX_NOTIFICATION_PURPOSE Purpose, DWORD* pNotifications)
{
    return LiveEngine_GetNotifications(pThis, Port, Purpose, pNotifications);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_SetProperty(LiveEngine* pThis, UIX_PROPERTY_TYPE Property, DWORD Value)
{
    return LiveEngine_SetProperty(pThis, Property, Value);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_GetProperty(LiveEngine* pThis, UIX_PROPERTY_TYPE Property, DWORD* pValue)
{
    return LiveEngine_GetProperty(pThis, Property, pValue);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_GetExitInfo(LiveEngine* pThis, UIX_EXIT_INFO* pExitInfo)
{
    return LiveEngine_GetExitInfo(pThis, pExitInfo);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_Reboot(LiveEngine* pThis, DWORD Context)
{
    return LiveEngine_Reboot(pThis, Context);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_LogOff(LiveEngine* pThis)
{
    return LiveEngine_LogOff(pThis);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_GetFeatureInterface(LiveEngine* pThis, UIX_FEATURE FeatureID, const VOID* pParam, VOID** ppFeatureInterface)
{
    return LiveEngine_GetFeatureInterface(pThis, FeatureID, pParam, ppFeatureInterface);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_GetSelectionInfo(LiveEngine* pThis, UIX_SELECTION_INFO* pSelectionInfo)
{
    return LiveEngine_GetSelectionInfo(pThis, pSelectionInfo);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_EndFeature(LiveEngine* pThis)
{
    return LiveEngine_EndFeature(pThis);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_ClearInput(LiveEngine* pThis)
{
    return LiveEngine_ClearInput(pThis);
}
UIXINLINE HRESULT WINAPI
ILiveEngine_UseVoiceMail(LiveEngine* pThis, UIX_VOICE_MAIL_ENTRY_POINT VoiceMailEntryPoint)
{
...
UIXINLINE HRESULT WINAPI
ILiveEngine::DoWork(DWORD* pDoWorkFlags)
{
    return LiveEngine_DoWork(this, pDoWorkFlags);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::SetUIPlugin(ITitleUIPlugin* pUIPlugin)
{
    return LiveEngine_SetUIPlugin(this, pUIPlugin);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::SetAudioPlugin(ITitleAudioPlugin* pAudioPlugin)
{
    return LiveEngine_SetAudioPlugin(this, pAudioPlugin);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::EnableFeature(UIX_FEATURE FeatureID)
{
    return LiveEngine_EnableFeature(this, FeatureID);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::StartFeature(UIX_FEATURE FeatureID, const VOID* pFeatureParams)
{
    return LiveEngine_StartFeature(this, FeatureID, pFeatureParams);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::Render(IDirect3DSurface8* pSurface)
{
    return LiveEngine_Render(this, pSurface);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::SetInput(DWORD Port, const XINPUT_STATE* pInputState)
{
    return LiveEngine_SetInput(this, Port, pInputState);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::GetFriendsForUser(DWORD Port, ILiveFriendsList** ppFriendsList)
{
    return LiveEngine_GetFriendsForUser(this, Port, ppFriendsList);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::NotificationSetState(DWORD Port, DWORD StateFlags, XNKID SessionID, DWORD StateDataSize, const PVOID pStateData)
{
    return LiveEngine_NotificationSetState(this, Port, StateFlags, SessionID, StateDataSize, pStateData);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::GetNotifications(DWORD Port, UIX_NOTIFICATION_PURPOSE Purpose, DWORD* pNotifications)
{
    return LiveEngine_GetNotifications(this, Port, Purpose, pNotifications);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::SetProperty(UIX_PROPERTY_TYPE Property, DWORD Value)
{
    return LiveEngine_SetProperty(this, Property, Value);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::GetProperty(UIX_PROPERTY_TYPE Property, DWORD* pValue)
{
    return LiveEngine_GetProperty(this, Property, pValue);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::GetExitInfo(UIX_EXIT_INFO* pExitInfo)
{
    return LiveEngine_GetExitInfo(this, pExitInfo);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::Reboot(DWORD Context)
{
...
UIXINLINE HRESULT WINAPI
ILiveEngine::GetFeatureInterface(UIX_FEATURE FeatureID, const VOID* pParam, VOID** ppFeatureInterface)
{
    return LiveEngine_GetFeatureInterface(this, FeatureID, pParam, ppFeatureInterface);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::GetSelectionInfo(UIX_SELECTION_INFO* pSelectionInfo)
{
    return LiveEngine_GetSelectionInfo(this, pSelectionInfo);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::EndFeature()
{
    return LiveEngine_EndFeature(this);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::ClearInput()
{
    return LiveEngine_ClearInput(this);
}
UIXINLINE HRESULT WINAPI
ILiveEngine::UseVoiceMail(UIX_VOICE_MAIL_ENTRY_POINT VoiceMailEntryPoint)
{
