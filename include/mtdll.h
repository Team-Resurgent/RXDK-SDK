...
#ifndef _NTSUBSET_
#ifdef _XBOX
extern __declspec(thread) _ptiddata __ptd_cur;
#else
...
#ifdef _XBOX
void __stdcall _mtxthreadnotification(int fCreate);

#define _lock_locale(lc)
#define _unlock_locale(lc)
#else
#define _lock_locale(llf)       \
...
#if defined(_XBOX) && defined(_FILE_DEFINED)
